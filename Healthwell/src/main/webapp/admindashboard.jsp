...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="#" onclick="toggleSection('appointments')">Manage Appointments</a></li>
                <li><a href="#" onclick="toggleSection('medicalServices')">Manage Medical Health Services</a></li>
                <li><a href="#" onclick="toggleSection('mentalHealth')">Manage Mental Health Services</a></li>
                <li><a href="#" onclick="toggleSection('supportPrograms')">Manage Support Programs</a></li>
    ...
    <main>
        ...
        <section id="youthCamps">
            ...
            <p><a href="YouthCampServlet?action=view">View All Youth Camps</a></p>
            <p><a href="YouthCampServlet?action=add">Add New Youth Camp</a></p>
            <p><a href="YouthCampServlet?action=update">Update Youth Camp</a></p>
            <p><a href="YouthCampServlet?action=delete">Delete Youth Camp</a></p>
        </section>

        <section id="appointments">
            <h2>Appointments Management</h2>
            <p><a href="AppointmentsServlet?action=view">View All Appointments</a></p>
            <p><a href="addAppointment.jsp">Add New Appointment</a></p>
            <p><a href="updateAppointment.jsp">Update Appointment</a></p>
            <p><a href="deleteAppointment.jsp">Delete Appointment</a></p>
        </section>

        <section id="medicalServices">
            <h2>Medical Health Services Management</h2>
            <p><a href="MedicalServicesServlet?action=view">View All Medical Health Services</a></p>
            <p><a href="addMedicalService.jsp">Add New Medical Service</a></p>
            <p><a href="updateMedicalService.jsp">Update Medical Service</a></p>
            <p><a href="deleteMedicalService.jsp">Delete Medical Service</a></p>
        </section>

        <section id="mentalHealth">
            <h2>Mental Health Services Management</h2>
            <p><a href="MentalHealthServlet?action=view">View All Mental Health Services</a></p>
            <p><a href="addMentalHealthService.jsp">Add New Mental Health Service</a></p>
            <p><a href="updateMentalHealthService.jsp">Update Mental Health Service</a></p>
            <p><a href="deleteMentalHealthService.jsp">Delete Mental Health Service</a></p>
        </section>

        <section id="supportPrograms">
            <h2>Support Programs Management</h2>
            <p><a href="SupportProgramsServlet?action=view">View All Support Programs</a></p>
            <p><a href="addSupportProgram.jsp">Add New Support Program</a></p>
            <p><a href="updateSupportProgram.jsp">Update Support Program</a></p>
            <p><a href="deleteSupportProgram.jsp">Delete Support Program</a></p>
        </section>
    </main>
