...
<h4>Small Group Training Options:</h4>
<ul>
    <li>After School Run Club: Beginner running program for a 5K race.</li>
    <li>Barre - Ballet Basics: Introductory ballet class.</li>
    <li>Boxing - Boxing Fundamentals: Introductory boxing class.</li>
</ul>
