...
<body>
    ...
    <section>
        <h2>Register for a Youth Camp</h2>
        <form action="YouthCampServlet" method="post" class="reservation-form">
        <div class="centered-container">
        
            <h1>Join a Youth Camp</h1>
            ...
            <label for="camp">Select Youth Camp:</label>
            <select id="camp" name="camp" required>
                <option value="arts_crafts">Arts & Crafts Camp</option>
                <option value="adventure">Adventure Camp</option>
                <option value="sports">Sports Camp</option>
                <option value="science">Science Camp</option>
                <option value="music">Music Camp</option>
                <option value="nature">Nature Camp</option>
                <option value="theater">Theater Camp</option>
                <option value="cooking">Cooking Camp</option>
                <option value="robotics">Robotics Camp</option>
                <option value="dance">Dance Camp</option>
                <option value="leadership">Leadership Camp</option>
                <option value="writing">Writing Camp</option>
            </select>
            ...
            <label for="allergies">Any Allergies or Special Needs:</label>
